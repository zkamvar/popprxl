...
This package is a wrapper for [*poppr*](http://cran.r-project.org/package=poppr)
and [*readxl*](http://cran.r-project.org/package=readxl). When using this
...
```{r missing_cats, fig.width = 7, fig.height = 7}
